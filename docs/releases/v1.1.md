# v1 Release (6/15/2022)
[Official Release](https://github.com/Auddia/cicd/releases/tag/v1.1)

## Updates
* Added in support for installing local and private repos for [gcp_function_deployment Workflow](../../docs/workflows/gcp_function_deployment.md)
