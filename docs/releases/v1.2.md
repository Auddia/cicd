...
## Updates
* Fixed [circular import issue](https://github.com/APIDevTools/swagger-cli/issues/15) with `swagger-cli` in the `compile_openapi` action and `openapi_update` workflow by migrating part of the workload to `redocly`
